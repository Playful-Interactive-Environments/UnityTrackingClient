...
namespace Assets.Pharus_Tracking_Framework.TrackingEvaluation.Pharus
{
	/// <summary>
	...
	public class TracklinkRecorder : IRecorder
	{
		...
		#region buffer
		private void StoreContainer (TrackRecord trackRecord)
		{
		...
		protected virtual DataRow GetNewDataRow (TrackRecord trackRecord)
		{
